  ...
  detailBox.innerHTML = `
    ...
    <span>Age Calculator</span>
      ...
      <div class="two-col">
        ...
        <div class="mini-panel links-panel"><h3><i class="fa-solid fa-link"></i> Important Links</h3><table class="important-table"><tr><td>Apply Online</td><td><a href="${val(data, \"applyLink\", \"#\")}" target="_blank">Click Here</a></td></tr><tr><td>Download Notification</td><td><a href="${val(data,\"pdfLink\",\"#\")}" target="_blank">Click Here</a></td></tr><tr><td>Official Website</td><td><a href="${val(data,\"officialLink\",\"#\")}" target="_blank">Click Here</a></td></tr><tr><td>Syllabus</td><td><a href="index.html#syllabus">Click Here</a></td></tr></table></div>
