...
async function loadPost() {
    ...
    try {
        ...
        const loadedType = normalizeType(field(post,["type","category"],""));
        if(loadedType !== "scholarship"){
            renderError("This page is only for scholarship posts.");
            return;
        }
        document.title = `${field(post,["title"],"Scholarship Details")} - Rapid Job`;
        renderScholarshipDetail(post);
