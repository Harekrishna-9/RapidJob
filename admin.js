          ...
          <div class="message-card pro-message-card">
            <div class="msg-top">
              <div>
                ...
                <p class="msg-email">📧 ${esc(m.email || m.userEmail || m.customerEmail || m.mail || m.emailAddress || "No Email")}</p>
                <p class="msg-phone">📞 ${esc(m.phone || m.mobile || m.contact || m.number || m.phoneNumber || m.mobileNumber || m.whatsapp || "No Phone")}</p>
            ...
            <div class="msg-actions">
              <a class="reply-btn" href="mailto:${esc(m.email || m.userEmail || m.customerEmail || m.mail || m.emailAddress || "")}?subject=${encodeURIComponent("Reply: " + (m.subject || m.topic || "Rapid Job Message"))}&body=Hello ${esc(m.name || m.fullName || "")},%0D%0A%0D%0A">
